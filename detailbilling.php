        ...
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                            <th>รายการที่</th><th>ชื่อรายการ</th><th>จำนวน (ชิ้น)</th><th>ราคา (บาท/ชิ้น)</th><th>ราคารวม (บาท)</th><th></th>
                        </tr>
                       <?php 
                        $user_products_result=mysqli_query($con,$user_products_query) or die(mysqli_error($con));
                        $no_of_user_products= mysqli_num_rows($user_products_result);
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th></th><th></th><th>รวมทั้งสิ้น</th><th><?php echo $sum;?> บาท</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">ยืนยันการสั่งซื้อ</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
