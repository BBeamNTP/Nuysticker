    ...
    <div class="container">
        ...
        <table width="107%" class="table table-dark">
            ...
            <tr class="table-danger">
                <br>
                <th width="10%" height="52" class="text-center"><h4><b>รหัสสินค้า</th>
                <th width="20%" class="text-center"><h4><b>ประเภท</th>
                <th width="17%" class="text-center"><h4><b>ชื่อสินค้า</th>
                <th width="18%" class="text-center"><h4><b>ราคา(บาท)</th>
                <th width="23%" class="text-center"><h4><b>รูปสินค้า</th>
                <th width="9%"></th>
            </tr>
            <?php
            $user_products_result = mysqli_query($con, $user_products_query) or die(mysqli_error($con));
            ...
            while ($row = mysqli_fetch_array($user_products_result)) {
                ...
                <tr>
                    <form action="upload.php" method="post" enctype="multipart/form-data">
                        <th class="text-center"><h4><b><?php echo $row['id'] ?></th>
                        <th class="text-center"><?php if ($type == 'Letter') {
                                echo "ประเภทตัวอักษร";
                            } elseif ($type == 'Picture') {
                                echo "ประเภทรูป";
                        ...
                        <th class="text-center"><b><?php echo $row['name'] ?></th>
                        <th class="text-center"><b><?php echo number_format( $row['price'] , 2 ) . '' ?></th>
                        <th class="text-center"><img src="<?php echo $row['image'] ?>" width="200px" height="auto" border="0"/></th>
                        <th class="text-center">
                            ...
                            <input type="button" class="btn btn-danger" style="margin-bottom: 10px" name="btnConfirm"
                                   value="ลบรายการ"
                                   OnClick="chkConfirm()">
                            <input type="button" class="btn btn-warning" name="btnConfirm" value="แก้ไขสินค้า"
