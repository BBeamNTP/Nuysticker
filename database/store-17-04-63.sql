...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2020 at 05:27 PM
...
(1, 'Letter', 'à¸ªà¸²à¸¢à¸šà¸±à¸™à¹€à¸—à¸´à¸‡', 50, 'img/product/Letter/Letter1.jpg', NULL, NULL, NULL, NULL),
...
(8, 'à¸›à¸¸à¸“à¸¢à¸§à¸µà¸£à¹Œ à¸„à¸¥à¸²à¸¢à¸ à¸´à¸£à¸¡à¸¢à¹Œ', 'deartptp@gmail.com', '14e1b600b1fd579f47433b88e8d85291', '0917750965', 'à¹„à¸—à¸¢', '35/25 à¸¡.3 à¸–.à¸šà¸²à¸‡à¸à¸£à¸§à¸¢-à¹„à¸—à¸£à¸™à¹‰à¸­à¸¢ à¸•.à¸šà¸²à¸‡à¹€à¸¥à¸™ à¸­.à¸šà¸²à¸‡à¹ƒà¸«à¸à¹ˆ à¸ˆ.à¸™à¸™à¸—à¸šà¸¸à¸£à¸µ 11140', 'Member');
...
ALTER TABLE `users_items`
  ADD PRIMARY KEY (`id`), ADD KEY `user_id` (`user_id`,`item_id`), ADD KEY `item_id` (`item_id`), ADD KEY `bill_id` (`bill_id`);
